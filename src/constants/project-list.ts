...
export const projectList: Project[] = [
  {
    title: "Instagram Redesign inspiration",
    desciptions:
  ...
  },
  {
    ...
    desciptions:
      "React Seed Project: Inspired from past FrontEnd experiences, fine-tuned to my likings.",
    link: "https://github.com/ishan-srivastava/portfolio",
    techList: [
      TechName.REACT,
      TechName.REDUX,
  ...
  {
    title: "RoadRash inspiration",
    desciptions:
      "Inspired from the classic bike race game RoadRash, I made a small clone when I used to work in Java GUI in college",
  ...
  {
    title: "Pacman",
    desciptions: "Started as a hobby project back in college, written in Java",
